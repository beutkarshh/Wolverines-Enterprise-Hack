...
export function parseMHTCETResponse(raw) {
  const intentMatch = raw.match(/INTENT:\s*(\{.*?\})/s);
...
// Streaming version — yields tokens as they arrive; caller collects sentences for TTS
export async function* continueMHTCETConversationStream(chat, userMessage) {
